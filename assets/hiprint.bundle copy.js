            ...
            return Y(e, t), e.prototype.updateDesignViewFromOptions = function () {
                ...
                for (var u = e.outerHeight(), d = []; ;) {
                    ...
                    if (p) {
                        ...
                        this.printElementType.footerFormatter && e.find("tfoot") && p.target.find("tfoot").html(X.a.createTableFooter(this.printElementType.columns, this.getData(a), this.options, this.printElementType, a, d).html());
                        break;
                    }
                }
